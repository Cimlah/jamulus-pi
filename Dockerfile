...
RUN \
apt update && apt upgrade -y && apt install -y build-essential qt5-qmake qtdeclarative5-dev qt5-default qttools5-dev-tools wget git procps && apt update && apt upgrade -y && \
